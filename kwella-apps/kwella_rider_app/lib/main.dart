  ...
  ThemeData _buildTheme() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
        seedColor: KwellaTheme.brandTeal,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: KwellaTheme.brandTeal, width: 2),
        ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          backgroundColor: KwellaTheme.brandTeal,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [KwellaTheme.brandTeal, KwellaTheme.brandTealLight],
            ...
            const CircularProgressIndicator(
              valueColor:
                  AlwaysStoppedAnimation<Color>(KwellaTheme.brandTeal),
              strokeWidth: 2.5,
            ),
          ],
        ),
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        color:
                            KwellaTheme.textSecondary.withValues(alpha: 0.5),
                        fontSize: 12,
                      ),
                    ),
                  ),
...
// ---------------------------------------------------------------------------
// KwellaTheme – shared design tokens
// ---------------------------------------------------------------------------
abstract final class KwellaTheme {
  // Brand
  static const Color brandTeal = Color(0xFF00C9A7);
  static const Color brandTealLight = Color(0xFF00E5C4);
